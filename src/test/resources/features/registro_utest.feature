...
Característica: Pagina web Utest
  ...
  Esquema del escenario: Escenario: Escenario: Realizar el Registro en la web utest
    ...
    Ejemplos:
      ...
      | Jhonatan | Paternina | jhonatanpater1222@gmail.com | Spanish | Montería | 230003        | Colombia | Linux      | Fedora  | Spanish | Motorola          | Moto G8 Power | Android 11        | 123654987Jp | 123654987Jp      | Welcome to the world's largest community of freelance software testers! |
